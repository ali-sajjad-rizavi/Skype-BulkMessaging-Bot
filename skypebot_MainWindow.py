...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/skype.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.status_label.setGeometry(QtCore.QRect(340, 310, 261, 31))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(10)
        ...
        self.start_pushButton.setGeometry(QtCore.QRect(430, 250, 81, 41))
        self.start_pushButton.setObjectName("start_pushButton")
        self.waitingTime_spinBox = QtWidgets.QSpinBox(self.centralwidget)
        self.waitingTime_spinBox.setGeometry(QtCore.QRect(480, 191, 71, 31))
        self.waitingTime_spinBox.setMaximum(999999999)
        self.waitingTime_spinBox.setProperty("value", 3)
        self.waitingTime_spinBox.setObjectName("waitingTime_spinBox")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(350, 190, 121, 31))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "Waiting time (sec):"))
